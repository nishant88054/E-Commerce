  ...
  const features = [
    {
      ...
      description: 'Optimized performance with blazing fast load times and smooth interactions across all devices.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Enterprise-grade security with 99.9% uptime guarantee and automatic backups for peace of mind.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'User Friendly',
      description: 'Intuitive interface designed for everyone. No technical expertise required to get started.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Beautiful layouts that look perfect on desktop, tablet, and mobile devices automatically.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Customizable',
      description: 'Endless customization options to match your brand and create unique experiences.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <Container>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            Our comprehensive suite of tools empowers you to build faster and better.
          </p>
        </div>
